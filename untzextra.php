...
playerInstance.setup({
	sources: [{
	    file: "rtmp://untz.xen.prgmr.com/live/flv:game.flv"
	},{
	    file: "http:///untz.xen.prgmr.com/live/game/index.m3u8"
	},{
	    file: "http://untz.xen.prgmr.com/live/game/index.mp4"
	}],
	rtmp: {
...
function getStatus() {
    ...
    $('div#current').load('displayGameStreamer.php');
    $('div#viewcount').load('gameviews.php');
